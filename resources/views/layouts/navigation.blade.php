<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if(Auth::user()->usertype == 'admin')
                        <x-nav-link :href="route('training_sessions.index')" :active="request()->routeIs('training_sessions.index')">
                            {{ __('Manage Training Sessions') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->usertype == 'admin')
                <x-responsive-nav-link :href="route('training_sessions.index')" :active="request()->routeIs('training_sessions.index')">
                    {{ __('Manage Training Sessions') }}
                </x-responsive-nav-link>
